...
$(document).on("click", ".ViewDetail", function () {
    ...
    $.ajax({
        type: "POST",
        url: "/CommissionReport/_GetDatailOrder",
        data: {
            Date: Date,
            StoreId: StoreId,
...
function GetReportGrid(urlpara) {
    ...
    $.ajax({
        ...
        data: data,
        success: function (data) {
            $("#contentCommissionReport").html(data);
        },
        complete : function () {
            //LineChart();
        }
...
function GetUrl(condition) {
    ...
    switch (condition) {
        case 'q':
            Url = "/CommissionReport/_ReportPartialViewQ";
            break;
        case 'm':
            Url = "/CommissionReport/_ReportPartialViewM";
            break;
        default:
            Url = "/CommissionReport/_ReportPartialViewD";
            break;
    }
    return Url;
}
