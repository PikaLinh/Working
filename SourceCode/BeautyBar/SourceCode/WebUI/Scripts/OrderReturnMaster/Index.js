...
function LoadContent() {
    ...
    $.ajax({
        type: "POST",
        url: "/OrderReturnMaster/_SearchOrderReturnMaster?PageIndex=" + productconfig.PageIndex + "&PageSize=" + productconfig.PageSize,
        data: $("#formload").serialize(),
        success: function (data) {
            $("#OrderReturnMastercontent").html(data);
...
$(document).on('click', '.btn-ok', function (e) {
    ...
    var id = $("#idDelete").val();
    $.ajax({
        url: '/OrderReturnMaster/Cancel?id=' + id,
        success: function (data) {
