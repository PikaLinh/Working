    $(document).on("click", "#btnsearchproduct", function () {
        ...
        $.ajax({
            type: "POST",
            url: "/DynamicProductUpdates/_ProductPartial",
...
$(document).on("click", "#btnExport", function () {
    $.ajax({
        type: "POST",
        url: "/DynamicProductUpdates/Export",
        data: $("#frmtimproduct").serialize(),
        success: function (data) {
            var response = data;
        ...
        $("#fileupload").ajaxSubmit({
            ...
            success: function (data) {
                if (data == "success") {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/DynamicProductUpdates/_ProductUpdateList",
                        success: function (data) {
...
$('#confirm-delete').on('click', '.btn-ok', function (e) {
    ...
    var id = $("#idDelete").val();
    $.ajax({
        url: '/DynamicProductUpdates/Cancel?id=' + id,
        success: function (data) {
            if (data == "success") {
                $.ajax({
                    type: "POST",
                ...
                $.ajax({
                    type: "POST",
                    url: '/DynamicProductUpdates/ProductUpdateDetails',
                    success: function (data) {
...
$('#confirm-autoimex').on('click', '.btn-ok', function (e) {
    ...
    var id = $("#idDelete").val();
    $.ajax({
        url: '/DynamicProductUpdates/Autoimex?id=' + id,
        success: function (data) {
            if (data == "success") {
                $.ajax({
                    type: "POST",
...
$(document).on("click", ".btn-details", function (e) {
    ...
    $.ajax({
        type: "POST",
        url: '/DynamicProductUpdates/ProductUpdateDetails?id=' + id,
        success: function (data) {
            $("#contentProductUpdatesDetails").html(data);
            $("body").removeClass("loading2");
            Reinitialize('#datatableproduct');
...
$('#confirm-delete-product').on('click', '.btn-ok', function (e) {
    ...
    $.ajax({
        url: '/DynamicProductUpdates/DeleteProduct?id=' + id,
        success: function (data) {
            if (data == "success") {
                $.ajax({
                    type: "POST",
                    url: "/DynamicProductUpdates/ProductUpdateDetails?id=" + masterid,
                    success: function (data) {
                        $("#contentProductUpdatesDetails").html(data);
                        Reinitialize('#datatableproduct');
                    }
