...
$(document).on("click", "#btnsearchproduct", function () {
        ...
        $.ajax({
            type: "POST",
            url: "/WarehouseInventory/_ProductPartial",
        ...
        $("#fileupload").ajaxSubmit({
            ...
            success: function (data) {
                if (data == "success") {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/WarehouseInventory/WarehouseInventoryList",
                        success: function (data) {
...
$('#confirm-delete').on('click', '.btn-ok', function (e) {
    ...
    var id = $("#idDelete").val();
    $.ajax({
        url: '/WarehouseInventory/Cancel?id=' + id,
        success: function (data) {
            if (data == "success") {
                $.ajax({
                    type: "POST",
                ...
                $.ajax({
                    type: "POST",
                    url: '/WarehouseInventory/WarehouseInventoryProducts',
                    success: function (data) {
...
$('#confirm-autoimex').on('click', '.btn-ok', function (e) {
    ...
    var id = $("#idDelete").val();
    $.ajax({
        url: '/WarehouseInventory/Autoimex?id=' + id,
        success: function (data) {
            if (data == "success") {
                $.ajax({
                    type: "POST",
...
$(document).on("click", ".btn-details", function (e) {
    ...
    $.ajax({
        type: "POST",
        url: '/WarehouseInventory/WarehouseInventoryProducts?id=' + id,
        success: function (data) {
            $("#contentWarehouseInventoryProducts").html(data);
            Reinitialize('#datatableproduct');
            $("body").removeClass("loading2");
...
$('#confirm-delete-product').on('click', '.btn-ok', function (e) {
    ...
    $.ajax({
        url: '/WarehouseInventory/DeleteProduct?id=' + id,
        success: function (data) {
            if (data == "success") {
                $.ajax({
                    type: "POST",
